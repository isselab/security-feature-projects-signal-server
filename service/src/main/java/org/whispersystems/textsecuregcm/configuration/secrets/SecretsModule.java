...
@Critical(secrecy = {"SecretStore.secretBytesListFromBase64Strings(String):SecretBytesList", "SecretStore.secretStringList(String):SecretStringList", "SecretStore.secretString(String):SecretString", "SecretStore.secretBytesFromBase64String(String):SecretBytes"})
